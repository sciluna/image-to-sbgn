...
document.getElementById("imageInput").addEventListener("change", async function (file) {
...
document.getElementById("generateSBGNML").addEventListener("click", function () {
	communicate(base64data);
});
...
// send request to sbgn validator (sybvals) to validate the resulting sgbnml content
